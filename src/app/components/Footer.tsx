    ...
    <Link to={path} className="flex-[1_0_0] min-h-px min-w-px relative">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[2px] items-center justify-end pb-[4px] pt-[20px] relative w-full">
        ...
        <div className="content-stretch flex flex-col items-center relative shrink-0">
          <div className={`flex flex-col font-['Kranto',sans-serif] justify-center leading-[0] relative shrink-0 text-[11px] text-center tracking-[0.3px] whitespace-nowrap ${
            isActive 
...
export function Footer() {
  ...
  return (
    <div className="bg-[#011843] content-stretch flex items-start justify-center pb-[8px] pt-px relative w-full shrink-0" data-name="Nav - M3 NAVIGATION BAR">
      <div aria-hidden="true" className="absolute border-white/10 border-solid border-t inset-0 pointer-events-none shadow-[0px_-1px_3px_0px_rgba(0,0,0,0.2)]" />
      {tabs.map((tab) => (
        <NavButton
          key={tab.label}
          label={tab.label}
