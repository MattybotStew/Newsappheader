...
function NavButton({ label, path, icon, isActive }: NavButtonProps) {
  return (
    <Link to={path} className="flex-[1_0_0] flex flex-col justify-end items-center px-[4px] gap-[1px] h-[50px]">
      <div className={`flex h-[32px] w-full items-center justify-center rounded-[100px] ${isActive ? 'bg-white/20' : ''}`}>
...
export function Footer() {
  ...
  return (
    <div className="bg-[#011843] content-stretch flex items-start justify-center px-[4px] pt-[6px] pb-[calc(6px+env(safe-area-inset-bottom,0px))] fixed bottom-0 left-0 right-0 z-50 w-full" data-name="Nav - M3 NAVIGATION BAR">
