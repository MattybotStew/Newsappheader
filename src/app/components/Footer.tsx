...
function NavButton({ label, path, icon, isActive }: NavButtonProps) {
  return (
    <Link to={path} className="flex-[1_0_0] min-h-px min-w-px relative">
      <div className="flex flex-col gap-[2px] items-center justify-end pb-[4px] pt-[20px] w-full">
        <div className={`flex h-[32px] items-center justify-center rounded-[100px] shrink-0 w-[64px] ${isActive ? 'bg-white/20' : ''}`}>
